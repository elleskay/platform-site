...
const APPS = [
  ...
  { name: "ScamShield (Unofficial)", cat: "OGP Reconstructed", tag: "OGP Reconstructed", color: "var(--color-ok)", note: "Check a message, number, or email for an instant verdict, report scams, and watch a reviewer verify them. Rebuilt from OGP's public product updates to understand how they approach the problem. Not affiliated with OGP.", live: "https://elleskay.github.io/scamshield/", repo: "https://github.com/elleskay/scamshield", shot: scamShot },
