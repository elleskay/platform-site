...
const APPS = [
  { name: "IRAS Tax Assistant", cat: "Tax", tag: "AI · Tax", color: "#38bdf8", note: "Conversational Singapore tax help: GST, income, corporate, and SRS, with multi-model routing and human escalation.", live: "https://d1yl1box414d2i.cloudfront.net", repo: "https://github.com/elleskay/iras-tax-assistant", shot: irasShot },
  { name: "DriveBuddy", cat: "Mobility", tag: "AI · Mobility", color: "#818cf8", note: "AI driving companion for Singapore: live trip tracking, cost breakdowns, real-time ERP and traffic, and a voice assistant.", live: "https://elleskay.github.io/drivebuddy/", repo: "https://github.com/elleskay/drivebuddy", shot: driveShot },
  ...
  { name: "ScamShield (Unofficial)", cat: "OGP Reconstructed", tag: "OGP Reconstructed · Safety", color: "var(--color-ok)", note: "Check a message, number, or email for an instant verdict, report scams, and watch a reviewer verify them.", live: "https://elleskay.github.io/scamshield/", repo: "https://github.com/elleskay/scamshield", shot: scamShot },
  { name: "Armoury (Unofficial)", cat: "OGP Reconstructed", tag: "OGP Reconstructed", color: "#fbbf24", note: "Digital equipment checklists for frontline agencies, with an HQ readiness dashboard.", live: "https://d6a3alh51t58d.cloudfront.net", repo: "https://github.com/elleskay/armoury", shot: armouryShot },
];

const CATS = ["All", "Tax", "Healthcare", "Insurance", "Mobility", "OGP Reconstructed"];
