...
const APPS = [
  { name: "IRAS Tax Assistant", cat: "Tax", tag: "AI · Tax", color: "#0ea5e9", note: "Conversational Singapore tax help: GST, income, corporate, and SRS, with multi-model routing and human escalation.", live: "https://d1yl1box414d2i.cloudfront.net", repo: "https://github.com/elleskay/iras-tax-assistant", shot: irasShot },
  ...
  { name: "ScamShield (Unofficial)", cat: "OGP Reconstructed", tag: "OGP Reconstructed", color: "var(--color-ok)", note: "Check a message, number, or email for an instant verdict, report scams, and watch a reviewer verify them. Not affiliated with OGP.", live: "https://elleskay.github.io/scamshield/", repo: "https://github.com/elleskay/scamshield", shot: scamShot },
  { name: "Armoury (Unofficial)", cat: "OGP Reconstructed", tag: "OGP Reconstructed", color: "#d97706", note: "Digital equipment checklists for frontline agencies, with an HQ readiness dashboard. Not affiliated with OGP.", live: "https://d6a3alh51t58d.cloudfront.net", repo: "https://github.com/elleskay/armoury", shot: armouryShot },
];
