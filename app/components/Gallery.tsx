...
const APPS = [
  ...
  { name: "ScamShield", cat: "OGP Reconstructed", tag: "OGP Reconstructed · Safety", color: "var(--color-ok)", note: "Check a message, number, or email for an instant verdict, report scams, and watch a reviewer verify them.", live: "https://elleskay.github.io/scamshield/", repo: "https://github.com/elleskay/scamshield", shot: scamShot },
  { name: "Armoury", cat: "OGP Reconstructed", tag: "OGP Reconstructed", color: "#fbbf24", note: "Digital equipment checklists for frontline agencies, with an HQ readiness dashboard.", live: "https://d6a3alh51t58d.cloudfront.net", repo: "https://github.com/elleskay/armoury", shot: armouryShot },
];
