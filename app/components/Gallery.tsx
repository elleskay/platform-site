...
const APPS = [
  ...
  { name: "IRAS Tax Assistant", cat: "OGP Reconstructed", tag: "AI · Tax", color: "#38bdf8", note: "Conversational Singapore tax help: GST, income, corporate, and SRS, with multi-model routing and human escalation.", live: "https://d1yl1box414d2i.cloudfront.net", repo: "https://github.com/elleskay/iras-tax-assistant", shot: irasShot },
...
const CATS = ["All", "OGP Reconstructed", "Healthcare", "Insurance", "Mobility"];
